...
import { IFreenasState, getEncryptedVolumes } from './../../store/reducers/index';
...
export class CreateShortcutComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router, private configService: ConfigService, private store: Store<IFreenasState>) {}
